...
class PostMazadForm extends StatefulWidget {
  final Posmaz? post;
  final String? title;

  PostMazadForm({this.post, this.title});

  @override
  _PostMazadFormState createState() => _PostMazadFormState();
}

class _PostMazadFormState extends State<PostMazadForm> {
                ...
                Form(
                  ...
                  child: Padding(
                    ...
                    child: TextFormField(
                      ...
                      maxLines: 9,
                      validator: (val) =>
                      val!.isEmpty ? 'مطلوب كتابة نص المزاد' : null,
