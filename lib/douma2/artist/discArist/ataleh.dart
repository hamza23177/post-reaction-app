...
class Ataleh extends StatefulWidget {
  @override
  _AtalehState createState() => _AtalehState();
}

class _AtalehState extends State<Ataleh> with SingleTickerProviderStateMixin {
          ...
          ListView(
            ...
            children: [
              ...
              cards(
                ...
                Icons.person,
                UserPagePhone(
                  username: 'أبو محمد العفا',
                  about:
                  'ورشة عتالة ونقل أثاث المنازل والخدمات الأخرى',
                  phoneNumber: '0945285600',
                ),
              ),
            ],
          ),
